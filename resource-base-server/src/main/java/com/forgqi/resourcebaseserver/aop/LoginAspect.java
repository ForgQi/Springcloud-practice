...
public class LoginAspect {
    ...
    public LoginAspect(LoginFeignClient loginFeignClient, JwkFeignClient jwkFeignClient) {
    ...
    @Before(value = "execution(* com.forgqi.resourcebaseserver.service.client.JwkService.saveStuInfo(..)) && " +
            "args(loginDTO)")
    public void loginFirst(LoginDTO loginDTO) throws IOException {
        Response response = loginFeignClient.post(loginDTO.convertToMap());
